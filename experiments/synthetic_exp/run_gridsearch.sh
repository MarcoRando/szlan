...
fun_names=('Ackley' 'Levy' 'StyblinkskiTang' 'Griewank' 'Rastrigin' 'Rosenbrock' 'Quing')
regularization=(0) #1)
# 10)
#('Ackley')
...
#            echo "[$(ps aux  | grep grid_search | wc -l) -ge $MAX_PROCS )"
            ...
            python3 grid_search.py 'szlan' $fun_name --d $d --reg $reg --budget $budget --reps $reps --num-workers $num_workers --out-dir $out_dir --seed $seed &
#            python3 grid_search.py 'cmaes' $fun_name --d $d --reg $reg --budget $budget --reps $reps --num-workers $num_workers --out-dir $out_dir --seed $seed &
            python3 grid_search.py 'cbo' $fun_name --d $d --reg $reg --budget $budget --reps $reps --num-workers $num_workers --out-dir $out_dir --seed $seed &
            python3 grid_search.py 'de_2p' $fun_name --d $d --reg $reg --budget $budget --reps $reps --num-workers $num_workers --out-dir $out_dir --seed $seed &
            python3 grid_search.py 'pso' $fun_name   --d $d --reg $reg --budget $budget --reps $reps --num-workers $num_workers --out-dir $out_dir --seed $seed &    
