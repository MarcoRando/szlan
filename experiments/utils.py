...
from synthetic_functions_torch import * #RosenbrockFunction, LeastSquares, RastriginFunction, LevyFunction, QuingFunction, GriewankFunction, AckleyFunction, StyblinksiTangFunction
...
def get_objective_function(fun_name, d, dtype, device):
    if fun_name == 'ZigZag':
